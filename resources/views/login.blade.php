            ...
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    @if (Session()->has('registerSuccess'))
                        <h2 style="color:blue">{{ Session()->get('registerSuccess') }}</h2>
                    @endif

                    @if (Session()->has('loginEror'))
                        <h2 style="color:red">{{ Session()->get('loginEror') }}</h2>
                    @endif
                    <form class="space-y-4 md:space-y-6" action="/loginAcc" method="POST">
                        @csrf
                        <div>
